"""Generate Hepatic Fissure Duct assets in Blender.

Mac mini workflow:
npm run job:hepaticfissure
"""
...
def add_ellipsoid(name: str, loc: tuple[float, float, float], scale: tuple[float, float, float], rot_z: float, material: bpy.types.Material) -> bpy.types.Object:
    bpy.ops.mesh.primitive_uv_sphere_add(segments=72, ring_count=30, radius=1, location=loc)
    obj = bpy.context.object
    obj.name = name
    obj.scale = scale
    obj.rotation_euler = (math.radians(4), 0, math.radians(rot_z))
...
def add_parts() -> list[bpy.types.Object]:
    lobe_material = make_material("wet_hepatic_lobe_mass", (0.62, 0.065, 0.13, 1.0), 0.16, 0.045)
    rim_material = make_material("compressed_hepatic_fissure_lips", (0.43, 0.025, 0.065, 1.0), 0.16, 0.045)
    dark_material = make_material("near_black_hepatic_fissure", (0.004, 0.0, 0.003, 1.0), 0.72)
    duct_material = make_material("dark_crimson_embedded_bile_duct", (0.32, 0.01, 0.035, 1.0), 0.18, 0.05)
    objects: list[bpy.types.Object] = []
    objects.append(add_ellipsoid("hepatic_left_compressed_lobe", (-28, -25, 9), (38, 13, 30), -16, lobe_material))
    objects.append(add_ellipsoid("hepatic_right_compressed_lobe", (25, -27, -8), (34, 12, 28), 18, lobe_material))
    objects.append(add_ellipsoid("hepatic_upper_lobe_pressure", (-2, -18, 24), (30, 10, 18), 4, lobe_material))
    objects.append(add_ellipsoid("hepatic_lower_lobe_pressure", (2, -34, -28), (32, 11, 18), -6, lobe_material))
    objects.append(add_ellipsoid("hepatic_deep_central_fissure", (0, -43, -1), (18, 7, 34), 0, dark_material))
    for index, (x, y, z, sx, sz, angle) in enumerate([(-14, -40, 10, 17, 19, -20), (15, -40, -9, 17, 19, 20), (0, -39, 29, 14, 13, 5), (1, -40, -31, 14, 13, -8)]):
        objects.append(add_ellipsoid(f"hepatic_fissure_compressed_lip_{index + 1}", (x, y, z), (sx, 2.6, sz), angle, rim_material))
    objects.append(make_tube("hepatic_embedded_bile_duct_primary", [(-2, -42, -3), (-14, -56, -15), (-26, -61, -25), (-40, -56, -34)], 5.8, duct_material))
    objects.append(make_tube("hepatic_embedded_bile_duct_secondary", [(5, -42, 5), (18, -54, 15), (30, -58, 20), (43, -54, 24)], 4.5, duct_material))
    return objects
...
def setup_scene(objects: list[bpy.types.Object]) -> None:
    ...
    scene.view_settings.exposure = 1.46
    ...
    for obj in objects:
        ...
        obj.location.z += 74
    bpy.ops.object.empty_add(type="PLAIN_AXES", location=(0, -25, 74))
    ...
    fill.data.color = (1.0, 0.54, 0.56)
    fill.data.size = 230


def add_preview_backdrop() -> None:
    mat = make_material("hepatic_preview_dark_backdrop", (0.006, 0.001, 0.003, 1.0), 0.95)
