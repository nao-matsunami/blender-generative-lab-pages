...
scripts = [
    ...
    PROJECT_ROOT / "offline" / "generate_pancreatic_membrane_slab.py",
    ...
    PROJECT_ROOT / "offline" / "generate_pyloric_fold_gate.py",
    PROJECT_ROOT / "offline" / "generate_biliary_duct_cleft.py",
    PROJECT_ROOT / "offline" / "generate_aortic_root_clamp.py",
    PROJECT_ROOT / "offline" / "generate_pericardial_root_adhesion.py",
    PROJECT_ROOT / "offline" / "generate_septal_valve_burrow.py",
    PROJECT_ROOT / "offline" / "generate_renal_hilum_cleft.py",
    PROJECT_ROOT / "offline" / "generate_splenic_pulp_lacuna.py",
    PROJECT_ROOT / "offline" / "generate_alveolar_crypt_cluster.py",
    PROJECT_ROOT / "offline" / "generate_pancreatic_acinar_cleft.py",
    PROJECT_ROOT / "offline" / "generate_hepatic_fissure_duct.py",
    PROJECT_ROOT / "offline" / "generate_ventricular_valve_annulus.py",
]
